      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            <p className="card-subtitle">Stay on track with gentle nudges</p>
          </div>
        </div>
          ...
          <div className="grid" style={{ gap: 12 }}>
            <FormField label="Habit">
              <select
                className="select"
                value={draft.habitId}
                onChange={(e) => setDraft((d) => ({ ...d, habitId: e.target.value }))}
              >
                {habits.map((h) => (
            ...
            <div className="grid cols-2" style={{ gap: 12 }}>
              ...
              <FormField label="Enabled">
                <button type="button" className="btn" onClick={() => setDraft((d) => ({ ...d, enabled: !d.enabled }))}>
            ...
            <FormField label="Days">
              ...
              <div className="help">Choose days of week (Mon–Sun).</div>
            </FormField>
            ...
            <div className="notice">
              Demo tip: use “Ping now” below to push a reminder notification and see it in the notifications drawer.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="list">
            ...
            {reminders.length === 0 ? <div className="notice">No reminders yet.</div> : null}
          </div>
        </div>
      </div>
    </div>
